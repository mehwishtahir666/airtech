...
return(
    <>
    <div className="testimonials-div container-fluid border-0 border-danger ">
        <div className="testimonial_sub-div row h-100 w-100  d-flex align-items-center  ">
            ...
            <div className="testimonial_row row border-0 border-success m-auto mt-4  ">
                ...
                <div className="testimonial_col_row1 row border-0 border-success mt-2">
                    ...
                    <div className="testimonial_col_row1 row border-0 border-success mt-2">
                        <div className="col border-0 border-danger h-100 d-flex align-items-center">
                            < BsCheck2Circle className="t_icon fs-2 "/>
                            <h2 className="fs-5 mx-4 mt-1 ">We have 10+ years of successful marketing partnerships under our belt</h2>
                    ...
                    <div className="testimonial_col_row1 row border-0 border-success mt-2">
                        <div className="col border-0 border-danger h-100 d-flex align-items-center">
                            < BsCheck2Circle className="t_icon fs-2 "/>
                            <h2 className="fs-5 mx-4 mt-1 ">On average, we’ve helped our clients achieve a 780% ROI</h2>
                        ...
                        <div className="col border-0 border-danger h-100 d-flex align-items-center">
                            < BsCheck2Circle className="t_icon fs-2 "/>
                            <h2 className="fs-5 mx-4 mt-1 ">We've created new opportunities for growth for all of our clients</h2>
            ...
            <p className="testimonial-btn-p fs-5 fw-bolder ">BOOK A FREE CONSULTANT</p>
            </div>
